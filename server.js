...
app.post('/rider',(req,res)=>
{
  ...
  console.log(s.RName+" is searching for a driver.......");
  rider.push(s);
...
app.post('/driver',(req,res)=>
{
  ...
  console.log(s1.DName+ " is searching for a rider.......");
  driver.push(s1);
...
app.post('/rating',(req,res)=>
{
  ...
  MongoClient.connect('mongodb://localhost:27017/ratingDb',{useUnifiedTopology: true}, function (err, client) {
  if (err) throw err

  var db = client.db('ratingDb');
  var myobj =
